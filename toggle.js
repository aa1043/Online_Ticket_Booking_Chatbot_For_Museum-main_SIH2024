...
// //         chatbotContainer.classList.remove('hidden');
// //         // Reset styles to start the animation from the initial state
// //         gsap.set(chatbotContainer, { scale: 0.8, opacity: 0 });
// //         gsap.to(chatbotContainer, { 
// //             duration: 0.8,  // Duration for the animation
// //             scale: 1, 
// //             opacity: 1, 
// //             // ease: "expo.out"  // Easing function for smooth transition
// //         });
// //     } else {
// //         // Hide the chatbot with smooth animation
// //         gsap.to(chatbotContainer, { 
// //             duration: 0.8,  // Duration for the animation
// //             scale: 0.9, 
// //             opacity: 0, 
// //             // ease: "expo.in",  // Easing function for smooth transition
// //             onComplete: () => {
// //                 chatbotContainer.classList.add('hidden');
// //             }
// //         });
